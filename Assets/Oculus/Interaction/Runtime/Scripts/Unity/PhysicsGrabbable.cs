...
namespace Oculus.Interaction
{
    public class PhysicsGrabbable : MonoBehaviour
    {
        ...
        ////////// CHANGED ////////////
        // _linearVelocity and _angularVelocity from private to public LinearVelocity and AngularVelocity
        public bool HasPendingForce;
        ...
        private void FixedUpdate()
        {
            if (HasPendingForce)
            {
                ...
                WhenVelocitiesApplied(LinearVelocity, AngularVelocity);
            }
        }
